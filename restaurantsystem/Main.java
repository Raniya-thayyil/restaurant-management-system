...
public class Main {
    ...
    public static void main(String[] args) {        
        ...
        FoodItem chickenBiriyani = new FoodItem("chicken Biriyani", 100, "half", true);
        wiltonMenu.addItems(chickenBiriyani);
        FoodItem friedRice = new FoodItem("Veg fried rice", 150, "full", false);
        wiltonMenu.addItems(friedRice);
        FoodItem noodles = new FoodItem("Chicken noodles", 200, "half", true);
        wiltonMenu.addItems(noodles);
        FoodItem pasta = new FoodItem("Veg pasta", 300, "full", false);
        ...
        arun.addItems(wilton, noodles, 2);
        arun.addItems(wilton, chickenBiriyani, 2);
        ...
        tina.addItems(wilton, noodles, 2);
